...
@app.route('/api/tour/search/<string:search_input>', methods=['GET'])
def api_set_text_search(search_input):
    """
    ...
    """
    try:
        search_results = db.session.query(Text).filter(Text.text_content.ilike(f"%{search_input}%")).all()
